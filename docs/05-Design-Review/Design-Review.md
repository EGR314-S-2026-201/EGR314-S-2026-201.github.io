...
## External Design Review Overview
...
The external design review presentation is divided among team members, with each member responsible for explaining a specific portion of the project design.

### Introduction and Concepts

- **Team Introduction — Kelton**  
- **Mission Statement — K**

### Concept Designs

- **Concept Design #1: Boat Robot — Jacob**  
- **Concept Design #2: Fire Robot — Levi**

### Project Requirements

- **Project Requirements Overview — Hafsa**

Subsystem design responsibilities:

- **Movement Subsystem — Jacob**  
- **Camera Subsystem — Austin**  
- **Sensor Subsystem — Seth**  
- **Controller Subsystem — Michael**
...
The external design review serves as a checkpoint in the engineering design process. The review helps identify weaknesses in the design and provides technical feedback from external reviewers.

Results from the review will be used to:

- Refine subsystem designs  
- Improve documentation clarity  
- Address technical risks early  
- Strengthen the final system architecture

...
| The controller features an OLED display to visually indicate data to the user | OLED display reading out sensor data | N | Team 201A | Display to show camera images (User interface and interaction) |

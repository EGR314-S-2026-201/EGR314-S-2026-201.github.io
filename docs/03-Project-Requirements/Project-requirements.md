...
| The robot is capable of optical inspection | Some form of photoresistive or lidar sensor is used | An optical camera is used | Y |  | LiDAR scanning (Types of modules) |
